...
const pathAllowlist = new Map([
  ...
  ['core/character/persona.ts', 'GAL roleplay framing copy and built-in seed character follow the card authored language (fork single-locale Simplified Chinese), same policy as bundled Skill content'],
  ...
  ['entrypoints/gal/helpers.ts', 'GAL overlay typed helpers: friendly tool-name labels plus save/affinity helpers for the fork single-locale Chinese stage UI'],
...
const lineAllowlist = [
  ...
  },
  {
    ...
    includes: '我(?:将|会|想|要|先|让|再|直接|现在|继续|尝试|开始|需要|还需要|仍需|打算|计划|马上|随后|稍后|先去|先来|接下来)',
