...
type Tab = 'chat' | 'library' | 'projects' | 'capabilities' | 'settings' | 'characters';
...
const TABS: { key: Tab; labelKey: LocaleMessageKey; icon: string }[] = [
  ...
  { key: 'characters', labelKey: 'app.tabs.characters', icon: 'M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 20.25a7.5 7.5 0 0115 0' },
    ...
    <div className={isFloatingChat ? 'ds-app-shell ds-app-shell-floating-chat' : 'ds-app-shell'}>
      ...
      <main className="ds-app-main">
        ...
        <Suspense fallback={<RouteFallback />}>
          ...
          {!isFloatingChat && tab === 'characters' && <CharacterPage />}
