...
export const RUNTIME_COMMAND_CONTRACTS = {
  ...
  UPDATE_LOCAL_SKILL_SOURCE: typedCommand('payload-decoded', 'value-or-domain-error'),
  RELOCATE_LOCAL_SKILL_SOURCE: typedCommand('payload-decoded', 'value-or-domain-error'),
  ...
  GET_CHARACTERS: typedCommand('none', 'value'),
  SAVE_CHARACTER: typedCommand('payload-decoded', 'value'),
  DELETE_CHARACTER: typedCommand('payload-decoded', 'ack'),
  GET_ACTIVE_CHARACTER: typedCommand('none', 'nullable-value'),
  SET_ACTIVE_CHARACTER: typedCommand('payload-decoded', 'ack'),
  GET_GAL_SETTINGS: typedCommand('none', 'value'),
  SAVE_GAL_SETTINGS: typedCommand('payload-decoded', 'value'),
  GET_GROUPS: typedCommand('none', 'value'),
  SAVE_GROUP: typedCommand('payload-decoded', 'value'),
  DELETE_GROUP: typedCommand('payload-decoded', 'ack'),
  GET_ACTIVE_GROUP: typedCommand('none', 'nullable-value'),
  SET_ACTIVE_GROUP: typedCommand('payload-decoded', 'ack'),
  GET_PROMPT_INJECTION_SETTINGS: typedCommand('none', 'value'),
  SAVE_PROMPT_INJECTION_SETTINGS: typedCommand('payload-decoded', 'value'),
  GET_SKILL_AUTO_ACTIVATION_SETTINGS: typedCommand('none', 'value'),
  SAVE_SKILL_AUTO_ACTIVATION_SETTINGS: typedCommand('payload-decoded', 'value'),
