export const sidepanel = {
  ...
  characterPage: {
    title: 'GAL Characters',
    description: 'Manage roleplay character cards. The active character is injected as the persona in DeepSeek web chats with character-scoped memories; deactivating character mode returns to your own system-prompt preset.',
    create: 'New character',
    switchTo: 'Make current',
    deactivate: 'Deactivate character mode',
    activeMeta: 'Active',
    empty: 'No characters yet',
    emptyHelp: 'Click “New character”, or say “you play XX…” in a DeepSeek chat and let GAL save the card.',
    deleteConfirm: 'Delete this character? Its character memories are kept (manage them on the Memories page).',
    edit: 'Edit',
    delete: 'Delete',
    memoryAction: 'Memories',
    activateHint: 'After setting up a character, open the GAL stage on chat.deepseek.com to start.',
    importCard: 'Import card (PNG)',
    exportCard: 'Export card',
    importSuccess: 'Imported {count} character card(s)',
    importFailed: 'Import failed: {error}',
    exportAll: 'Export all data',
    importAll: 'Import all data',
    exportAllDone: 'Exported all data (characters / groups / affinity / saves)',
    importAllDone: 'Imported all data ({count} characters)',
    importAllFailed: 'Full import failed: {error}',
    diaryAction: 'Diary',
    diaryTitle: 'Character diary',
    diaryHint: 'A timeline built from this character’s memories and group events (newest first).',
    diaryEmpty: 'No entries yet. Memories the AI keeps while chatting with this character show up here.',
    diaryGroupPrefix: 'Group',
    form: {
      newTitle: 'New character',
      editTitle: 'Edit character',
      nameLabel: 'Name',
      colorLabel: 'Accent color',
      avatarLabel: 'Portrait (image URL or extension path)',
      descriptionLabel: 'Character setup',
      personalityLabel: 'Personality',
      scenarioLabel: 'Scenario',
      exampleLabel: 'Example dialogue',
      ...
      expressionsLabel: 'Emotion portraits (optional — switched automatically by reply mood; blank falls back to the portrait above)',
      sceneLabel: 'Stage background (image URL, optional)',
      bgmLabel: 'Background music (audio URL, optional)',
      emotion: {
        happy: 'Happy portrait URL',
        angry: 'Angry portrait URL',
        shy: 'Shy portrait URL',
        sad: 'Sad portrait URL',
      },
      save: 'Save',
      cancel: 'Cancel',
    },
    memory: {
      ...
      hint: 'Injected only while this character is active; can be promoted to global.',
      globalCount: '{count} global shared memories (manage them on the Memories page)',
      empty: 'No character memories yet. Memories the model consolidates while chatting with this character are attributed here.',
      addNamePh: 'Name (one-line title)',
      addContentPh: 'Content: experiences worth remembering…',
      addBtn: 'Save to character memories',
      globalize: 'Make global',
      deleteMem: 'Delete',
    },
    backendUnavailable: 'Character storage is unavailable. Reload the extension and try again.',
    operationFailed: 'Character operation failed: {error}',
    tabs: {
    ...
    group: {
      ...
      form: {
        ...
        instructionsLabel: 'Group setup / rules (injected for every member)',
        membersLabel: 'Members',
        noMembers: 'No characters yet — create them on the Characters tab first.',
        save: 'Save',
        cancel: 'Cancel',
      },
      edit: 'Edit',
  ...
  galSettings: {
    title: 'GAL Stage',
    description: 'Roleplay stage and character persona injection (off by default — DeepSeek stays on its original UI; turning it on is remembered).',
    enabledLabel: 'Enable the GAL stage',
    enabledHint: 'When disabled the DeepSeek page keeps its original UI and never auto-overlays GAL.',
    cadenceLabel: 'Character persona injection cadence',
    cadenceEvery: 'Every message (character always present)',
    cadenceFirst: 'First message of each conversation only',
    cadenceOff: 'Never inject the character persona',
    proactiveLabel: 'Character starts talking when idle',
    proactiveHint: 'While the stage is open and you have been idle for a while, the character reaches out first (uses API quota).',
    proactiveMinutesLabel: 'Idle minutes before reaching out (1-240)',
    ttsLabel: 'Read character lines aloud (browser speech)',
    ttsHint: 'Speaks character replies with the system voice; each character keeps a stable voice profile. Silently degrades without a speech engine.',
    ttsRateLabel: 'Speech rate (0.5-2)',
    saved: 'Saved',
    loadFailed: 'Failed to load GAL settings: {error}',
