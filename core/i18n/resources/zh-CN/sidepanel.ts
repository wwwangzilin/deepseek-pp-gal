export const sidepanel = {
  ...
  characterPage: {
    title: 'GAL 角色',
    description: '管理角色扮演角色卡。激活的角色会在 DeepSeek 网页对话中作为人格注入，记忆按角色隔离；关闭角色模式后回到你原本的系统提示词预设。',
    create: '新建角色',
    switchTo: '设为当前',
    deactivate: '停用角色模式',
    activeMeta: '使用中',
    empty: '还没有角色',
    emptyHelp: '点「新建角色」创建第一个角色，或在 DeepSeek 对话里说“你扮演 XX…”让 GAL 自动存卡。',
    deleteConfirm: '删除该角色？其角色记忆仍保留（可在记忆页处理）。',
    edit: '编辑',
    delete: '删除',
    memoryAction: '记忆',
    activateHint: '设好角色后，到 chat.deepseek.com 打开 GAL 舞台开始对话。',
    importCard: '导入卡（PNG）',
    exportCard: '导出卡',
    importSuccess: '已导入 {count} 张角色卡',
    importFailed: '导入失败：{error}',
    exportAll: '导出全部数据',
    importAll: '导入全部数据',
    exportAllDone: '已导出全部数据（角色/群组/好感度/存档）',
    importAllDone: '已导入全部数据（角色 {count} 个）',
    importAllFailed: '导入全部数据失败：{error}',
    diaryAction: '日记',
    diaryTitle: '角色日记',
    diaryHint: '由该角色的记忆与群组事件生成的时间线（越往下越早）。',
    diaryEmpty: '还没有记录。与该角色对话后，AI 记住的内容会出现在这里。',
    diaryGroupPrefix: '群组',
    form: {
      newTitle: '新建角色',
      editTitle: '编辑角色',
      nameLabel: '名称',
      colorLabel: '主题色',
      avatarLabel: '立绘（图片 URL 或扩展内路径）',
      descriptionLabel: '角色设定',
      personalityLabel: '性格',
      scenarioLabel: '场景',
      exampleLabel: '示例对话',
      greetingLabel: '开场白',
      ...
      expressionsLabel: '表情立绘（可选：按回复情绪自动切换，留空则用上面的立绘）',
      sceneLabel: '场景背景（图片 URL，可选）',
      bgmLabel: '背景音乐（音频 URL，可选）',
      emotion: {
        happy: '开心立绘 URL',
        angry: '生气立绘 URL',
        shy: '害羞立绘 URL',
    ...
    memory: {
      title: '角色记忆',
      hint: '只在该角色激活时注入；可设为全局共享。',
      globalCount: '全局共享记忆 {count} 条（可在「记忆」页管理）',
      empty: '还没有角色记忆。与该角色对话时模型自动记住的内容会归属到这里。',
      addNamePh: '名称（一句话标题）',
      addContentPh: '内容：值得记住的经历…',
      addBtn: '保存到角色记忆',
      globalize: '设为全局',
      deleteMem: '删除',
    },
    backendUnavailable: '角色存储不可用，请重载扩展后重试。',
    operationFailed: '角色操作失败：{error}',
    tabs: {
      characters: '角色',
      groups: '群组',
    },
    group: {
      title: 'GAL 群组',
      description: '群组成员共享同一个项目的记忆与设定，像群聊一样互通；在 DeepSeek 页面 GAL 舞台顶栏「👥 群组」里勾选发言者开始群聊。',
      create: '新建群组',
      empty: '还没有群组',
      emptyHelp: '新建群组并选择成员；系统会自动为它创建一个共享项目（承载群组记忆与设定）。',
      memberCount: '{count} 名成员',
      form: {
        newTitle: '新建群组',
        editTitle: '编辑群组',
        nameLabel: '群组名',
        descriptionLabel: '群组简介',
        instructionsLabel: '群组设定 / 规则（注入给所有成员）',
        membersLabel: '成员',
        noMembers: '还没有角色，先到「角色」页创建。',
        save: '保存',
        cancel: '取消',
      },
      edit: '编辑',
      delete: '删除',
      deleteConfirm: '删除该群组？共享项目与其记忆会保留，可在项目页手动清理。',
      chatHint: '去 chat.deepseek.com 打开 GAL 舞台 → 顶栏「👥 群组」→ 进入群组并勾选本轮发言者。',
    },
  },
  galSettings: {
    title: 'GAL 舞台',
    description: '角色扮演舞台与角色提示词注入（默认关闭，保持 DeepSeek 原版界面；开启后选择会被记住）。',
    enabledLabel: '启用 GAL 舞台',
    enabledHint: '关闭时 DeepSeek 页面保持原版界面，不会自动叠加 GAL。',
    cadenceLabel: '角色提示词注入节奏',
    cadenceEvery: '每条消息都注入（角色始终在场）',
    cadenceFirst: '仅会话首条消息注入',
    cadenceOff: '不注入角色提示词',
    proactiveLabel: '空闲时角色主动搭话',
    proactiveHint: '舞台打开且长时间无互动时，角色会主动找你说一句（消耗 API 额度）。',
    proactiveMinutesLabel: '空闲几分钟后主动（1-240）',
    ttsLabel: '朗读角色台词（浏览器语音）',
    ttsHint: '用系统语音朗读角色回复，不同角色有固定音色区分（无语音引擎时静默降级）。',
    ttsRateLabel: '语速（0.5-2）',
    saved: '已保存',
    loadFailed: '读取 GAL 设置失败：{error}',
